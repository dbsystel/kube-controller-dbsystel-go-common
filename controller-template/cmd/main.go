...
import (
	...
	"github.com/dbsystel/kube-controller-dbsystel-go-common/controller-template/controller"
...
var (
	app = kingpin.New(filepath.Base(os.Args[0]), "Template Kubernetes Controller")
...
func main() {
	...
	level.Info(logger).Log("msg", "Starting Template Kubernetes Controller...")
